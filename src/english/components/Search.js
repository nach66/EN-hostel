...
export default class Search extends Component {
    ...
    handleSubmit = () => {
        ...
        window.open(
            ...
            nAdults=${this.state.adults}&nChilds=${this.state.childs}&nBabies=0&language=EN&rateCode=*ALL&roomId=&
            from=${formattedFrom}&to=${formattedTo}&minToDate=${formattedTo}
            &nochesPedidas=1&bloggerId=&languageDirection=ltr`
            , '_blank');
    }
                ...
                <div className="book-now-comp lang">
                    ...
                    <div style={{position: 'relative', display: 'inline-block'}}>
                        ...
                        <select 
                            ...
                            name='nAdults'>
                            <option disabled={true} value="">Adults:</option>
                        ...
                        <select 
                            ...
                            name='nChilds'>
                        <option disabled={true} value="">Childs:</option>
